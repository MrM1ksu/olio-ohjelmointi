...
void Car::setWheels()
{
    objWheel1.setSize(17), objWheel2.setSize(17), objWheel3.setSize(17), objWheel4.setSize(17);
    objWheel1.setType("kesarengas"), objWheel2.setType("kesarengas"), objWheel3.setType("kesarengas"), objWheel4.setType("kesarengas");
}
